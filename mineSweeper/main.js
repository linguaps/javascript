...
function flagCell(row, col) {
    //
    // TODO: Task 7 - Implement flags. Flags allow the player to mark cells that they think contain a bomb. When clicking a cell and holding shift, function flagCell() will be called for you.
    //
}
